...
const projects = [
  { 
    ...
    demo: "https://github.com/B-Ouassim/StageConnect",
    img: "StageConnect.png"
  },
  { 
    ...
    demo: "https://github.com/B-Ouassim/gs-project",
    img: "GS-Stock.png"
  },
  { 
    title: "React - Stock Management System", 
    desc: "Stock management system built with React(Redux), featuring dynamic inventory tracking and user-friendly interface.",  
  ...
  { 
    title: "Coffee Palace - Demo", 
    desc: "High-conversion landing page focused on fast load times and mobile UX.", 
    tech: ["React", "Tailwind", "Motion"],
    demo: "https://b-ouassim.github.io/Cafe-Landing-Page/ ",
    img: "coffee.png"
  },
  { 
    title: "Wealthome - Demo", 
    desc: "Booking platform for property listings.", 
    tech: ["HTML", "CSS", "JS"],
    demo: "https://b-ouassim.github.io/Wealthome-Property-Lister/Wealthome-Project-main",
    img: "wealthome.png"
  },
  { 
    title: "Password Generator", 
    desc: "Random password generator with customizable options.", 
    tech: ["HTML", "CSS", "JS"],
    demo: "https://b-ouassim.github.io/random-password-generator/Generate-Paswwords-main/",
    img: "password.png"
  },
  { 
    title: "Quiz App - Demo", 
    desc: "Interactive quiz application with real-time feedback.", 
    tech: ["HTML", "CSS", "JS"],
    demo: "https://b-ouassim.github.io/JS-Interactive-Quiz-App/Quiz-App-main/",
    img: "quiz.png"
  },
  { 
    title: "To-Do List - Demo", 
    desc: "Simple to-do list application with local storage persistence.", 
    tech: ["HTML", "CSS", "JS"],
    demo: "https://b-ouassim.github.io/JS-Local-Storage-ToDo-App/To-Do-List/",
    img: "todo.png"
  },
  { 
    title: "Weather App - Demo", 
    desc: "Weather application that provides real-time weather updates for any location.", 
